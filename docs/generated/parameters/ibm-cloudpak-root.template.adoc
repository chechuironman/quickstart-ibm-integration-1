...
(`ES`)|`False`|Choose "True" to install an example instance of the Event Streaming runtime.|Gateway
(`GW`)|`False`|Choose "True" to install an example instance of the Gateway service.|High Speed Transfers
